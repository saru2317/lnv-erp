...
const buildSearchIndex = (userModules = []) => {
  ...
  const index = [
    ...
    { type:'module', icon:'🏗️', label:'Civil',                  sub:'Projects · BOQ · Bills',   path:'/civil',            mod:'civil',   keywords:['civil','project','boq','contractor','construction'] },
    ...
    { type:'report', icon:'⚖️', label:'Balance Sheet',           sub:'FI → BS',                     path:'/fi/bs',              mod:'fi',      keywords:['balance sheet','bs','assets liabilities'] },
    ...
    { type:'master', icon:'🛡️', label:'Roles & Permissions',      sub:'Config → RBAC',   path:'/config/roles',          mod:'config',  keywords:['role','permission','rbac','access control'] },
  ]
