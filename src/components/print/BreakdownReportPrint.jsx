...
export default function BreakdownReportPrint({ data, onClose }) {
  return (
    <PrintWrapper title="Breakdown Report" onClose={onClose}>
      <div className="print-page">
        {/* Header */}
        <div style={{display:'flex',justifyContent:'space-between',borderBottom:'3px solid #C0392B',paddingBottom:12,marginBottom:16}}>
          <div>
          ...
          <div style={{textAlign:'right'}}>
            <div style={{background:'#C0392B',color:'#fff',padding:'8px 20px',borderRadius:6,fontFamily:'Syne,sans-serif',fontSize:14,fontWeight:800,letterSpacing:.5}}>
              Breakdown Report
            </div>
        ...
        <div style={{background:'#F8F9FA',border:'2px dashed #DDD',borderRadius:8,padding:32,textAlign:'center',color:'#999',marginBottom:20}}>
          ...
          <div style={{fontSize:13,fontWeight:600,color:'#714B67'}}>Breakdown Report</div>
