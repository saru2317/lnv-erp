...
export default function JournalEntryPrint({ data, onClose }) {
  return (
    <PrintWrapper title="Journal Entry" onClose={onClose}>
      <div className="print-page">
        ...
        <div style={{background:'#F8F9FA',border:'2px dashed #DDD',borderRadius:8,padding:32,textAlign:'center',color:'#999',marginBottom:20}}>
          ...
          <div style={{fontSize:13,fontWeight:600,color:'#714B67'}}>Journal Entry</div>
