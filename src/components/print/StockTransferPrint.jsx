...
export default function StockTransferPrint({ data, onClose }) {
  return (
    <PrintWrapper title="Stock Transfer Note" onClose={onClose}>
      <div className="print-page">
        ...
        <div style={{background:'#F8F9FA',border:'2px dashed #DDD',borderRadius:8,padding:32,textAlign:'center',color:'#999',marginBottom:20}}>
          ...
          <div style={{fontSize:13,fontWeight:600,color:'#714B67'}}>Stock Transfer Note</div>
