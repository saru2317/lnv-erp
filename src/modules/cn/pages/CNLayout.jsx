...
const SIDEBAR_GROUPS=[{label:'Canteen Management',icon:'',items:[{to:'/cn',label:'Dashboard'},{to:'/cn/coupon',label:'Meal Coupons'},{to:'/cn/billing',label:'Billing & Recovery'},{to:'/cn/menu',label:'Menu & Rates'},{to:'/cn/vendor',label:'Canteen Vendor'}]}]
