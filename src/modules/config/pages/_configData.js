...
export const ROLES = [
  ...
  { id:'ROLE-004', name:'operations', label:'Operations',      color:'#784212', bg:'#D1ECF1', desc:'Shop floor — production entry, work order queue only (no planning/masters access)',
    modules:['home','pp','qm','pm','wm','mm','tm','reports'] },
  { id:'ROLE-010', name:'planner',    label:'Production Planner', color:'#017E84', bg:'#D4EDDA', desc:'Planning, MRP, capacity, BOM/routing, work order creation',
    modules:['home','pp','qm','pm','wm','mm','tm','reports'] },
