...
const MOVEMENTS = [
  ...
  { type:'adjust',   dot:'', title:'Adjustment — Packing Boxes count variance', sub:'Physical count diff · BIN-F06 · 23 Feb 2025', qty:'-15 Nos' },
]
    ...
    <div>
      ...
      <div className="wm-kpi-grid">
        {[
          ...
          {cls:'orange',ic:'',lb:'Low Stock Items',    val:'4',     sub:'Below reorder level'},
      ...
      <div className="wm-panel">
        ...
        <div className="wm-panel-body" style={{display:'flex',gap:'10px',flexWrap:'wrap'}}>
          ...
          <button className="btn btn-s sd-bsm" onClick={() => nav('/wm/wh-map')}> Warehouse Map</button>
          <button className="btn btn-s sd-bsm" onClick={() => nav('/wm/adjustment')}> Stock Adjustment</button>
        </div>
      </div>
    </div>
  )
