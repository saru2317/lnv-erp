...
export const ACTION_CONFIG = {
  ...
  UPDATE: {cls:'audit-badge-update',rowCls:'audit-row-update',icon:'✏️'},
  DELETE: {cls:'audit-badge-delete',rowCls:'audit-row-delete',icon:'🗑️'},
  LOGIN:  {cls:'audit-badge-login', rowCls:'audit-row-login', icon:'🔐'},
  EXPORT: {cls:'audit-badge-export',rowCls:'audit-row-export',icon:'⬇️'},
