...
export const PRODUCTION_TYPES = {
  ...
  continuous: { label:'Continuous Process',     icon:'♾️', desc:'Non-stop line — textile, rolling mills' },
...
export const INDUSTRIES = {
  ...
  surface_treatment: {
    ...
    stages:[
      ...
      { id:'s6', name:'Curing / Oven',              icon:'🌡️', machine:'OVEN-01',  fields:['Temp (°C)','Duration (min)','Oven ID','Qty In','Qty Out','Operator'] },
  ...
  heat_treatment: {
    ...
    stages:[
      ...
      { id:'s5', name:'Tempering',                icon:'🌡️', machine:'TEMP-01',         fields:['Set Temp (°C)','Actual Temp (°C)','Soak Time (min)','Cooling Method','Operator'] },
  ...
  injection_moulding: {
    ...
    stages:[
      { id:'s1', name:'Material Drying',    icon:'☀️', machine:'DRYER-01', fields:['Material Grade','Lot No.','Dryer Temp (°C)','Drying Time (hrs)','Moisture % Before','Moisture % After','Operator'] },
      ...
      { id:'s4', name:'Production Run',     icon:'▶️', machine:'IMM-01',   fields:['Start Shot No.','End Shot No.','Shots Fired','Cycle Time (sec)','Barrel Temp (°C)','Mould Temp (°C)','Shot Weight (g)','Operator','Shift'], shotCounter:true },
      ...
      { id:'s6', name:'Degating / Trimming',icon:'✂️', machine:'TRIM-01',  fields:['Qty In','Gate Removed','Flash Trimmed','Qty Out','Rejection','Operator'] },
  ...
  blow_moulding: {
    ...
    stages:[
      ...
      { id:'s5', name:'Trimming / Deflashing', icon:'✂️', machine:'TRIM-01', fields:['Qty In','Flash Removed','Tail Removed','Qty Out','Rejection','Operator'] },
  ...
  rubber_moulding: {
    ...
    stages:[
      { id:'s1', name:'Compound Preparation', icon:'⚗️', machine:'MIXER-01',  fields:['Compound Grade','Lot No.','Batch Wt (Kg)','Mooney Viscosity','Compound Date','Prepared By'] },
      { id:'s2', name:'Preform / Slug Prep',  icon:'🔲', machine:'PREFORM-01',fields:['Preform Wt (g)','Preform Size','Qty Prepared','Operator'] },
      { id:'s3', name:'Moulding / Curing',    icon:'🌡️', machine:'PRESS-01',  fields:['Mould ID','Cavity Count','Curing Temp (°C)','Curing Time (min)','Press Tonnage','Shots Fired','Operator'], mouldSetup:true, shotCounter:true },
      { id:'s4', name:'Deflashing',           icon:'✂️', machine:'TRIM-01',   fields:['Qty In','Flash Wt (g)','Deflash Method','Qty Out','Rejection','Operator'] },
      { id:'s5', name:'Post Cure (if req)',   icon:'☀️', machine:'OVEN-01',   fields:['Temp (°C)','Duration (hrs)','Qty In','Qty Out','Technician'] },
  ...
  electroplating: {
    name:'Electroplating / Metal Finishing', icon:'⚗️', color:'#1F618D', light:'#EBF5FB',
  ...
  forging_casting: {
    name:'Forging / Casting Finishing', icon:'⚒️', color:'#784212', light:'#FEF5E7',
    ...
    stages:[
      ...
      { id:'s3', name:'Trimming / Flash Removal',icon:'✂️', machine:'TRIM-01',  fields:['Flash Wt (Kg)','Qty Trimmed','Rejection','Operator'] },
      { id:'s4', name:'Machining (if req)',      icon:'⚙️', machine:'MCH-01',   fields:['Operation','Machine','Qty Machined','Tolerance','Rejection','Operator'] },
  ...
  printing: {
    name:'Printing Industries', icon:'🖨️', color:'#1B4F72', light:'#D6EAF8',
    ...
    stages:[
      ...
      { id:'s4', name:'Printing Run',              icon:'🖨️', machine:'PRESS-01',fields:['Press Speed (m/min)','Impression Count','Color Registration','Ink Density','Waste Sheets','Operator','Shift'] },
      { id:'s5', name:'Lamination / Coating',      icon:'✨', machine:'LAM-01',  fields:['Lamination Type','Temp (°C)','Speed (m/min)','Qty (Meters)','Operator'] },
      { id:'s6', name:'Die Cutting / Slitting',    icon:'✂️', machine:'DIE-01',  fields:['Die ID','Cut Size','Qty Cut','Waste %','Operator'] },
  ...
  fabrication: {
    name:'Fabrication / Sheet Metal', icon:'🏗️', color:'#4D5656', light:'#EAECEE',
    ...
    stages:[
      ...
      { id:'s2', name:'Material Issue',      icon:'🗃️', machine:'STORE',   fields:['Material Code','Heat No.','Size (mm)','Qty Issued (Kg)','Mill Certificate No.','Store Keeper'] },
  ...
  textile: {
    ...
    stages:[
      ...
      { id:'s3', name:'Drawing',            icon:'➡️', machine:'DR-01',  fields:['Input Slivers','Output Qty (Kg)','Draft','Delivery Speed','Hank','Operator'] },
  ...
  manufacturing: {
    name:'Metal Manufacturing', icon:'⚙️', color:'#1A5276', light:'#D6EAF8',
    desc:'Fabrication · Assembly · Machining', prodType:'discrete',
    stages:[
      { id:'s1', name:'Raw Material Issue',  icon:'🗃️', machine:'STORE',   fields:['Material Code','Description','Qty Issued (Kg/Nos)','Heat No.','Batch No.','Store Keeper'] },
      { id:'s2', name:'Cutting / Shearing',  icon:'✂️', machine:'CUT-01',  fields:['Material','Size (mm)','Qty Cut','Scrap (Kg)','Blade Setting','Operator','Machine'] },
  ...
  chemical: {
    ...
    stages:[
      { id:'s1', name:'RM Weighing',         icon:'⚖️', machine:'SCALE-01',fields:['Batch No.','Material Code','Std. Qty (Kg)','Act. Qty (Kg)','Variance %','Chemist','Scale ID'] },
      ...
      { id:'s4', name:'Primer / Base Coat',  icon:'🖌️', machine:'SPRAY-01',fields:['DFT Target (µm)','DFT Actual (µm)','WFT (µm)','Coverage (m²)','Batch No.','Applicator'] },
      ...
      { id:'s6', name:'Curing / Drying',     icon:'🌡️', machine:'OVEN-01', fields:['Cure Type','Temperature (°C)','Time (min)','Humidity %','Hardness (H)','Technician'] },
  ...
  food: {
    ...
    stages:[
      ...
      { id:'s5', name:'Cooling / Setting',   icon:'❄️', machine:'COOL-01',  fields:['Target Temp (°C)','Act. Temp (°C)','Cooling Time (min)','Conveyor Speed','Operator'] },
      ...
      { id:'s7', name:'Labelling & Coding',  icon:'🏷️', machine:'LBL-01',   fields:['Mfg Date','Exp Date','Batch Code','Lot No.','Label Qty','MRP','Operator'] },
    ]
  },
  ...
  pharma: {
    ...
    stages:[
      { id:'s1', name:'Dispensing',           icon:'⚖️', machine:'DISPENSE',fields:['BMR No.','Material Name','Std Qty (Kg)','Act Qty (Kg)','A.R. No.','Mfg Date','Exp Date','Dispensed By','Checked By'] },
      ...
      { id:'s4', name:'Drying (FBD)',         icon:'🌡️', machine:'FBD-01',  fields:['Inlet Temp (°C)','Outlet Temp (°C)','Time (min)','Initial LOD %','Final LOD %','Batch Size (Kg)'] },
...
export const INDUSTRY_SUBTYPES = [
  ...
  { key:'cnc_jobwork',       emoji:'⚙️', name:'CNC Job Work',            icon:'⚙️', label:'CNC Job Work / Machining',       color:'#1A5276',
  ...
  { key:'forging_finish',    emoji:'⚒️', name:'Forging / Casting',       icon:'⚒️', label:'Forging / Casting Finishing',    color:'#784212',
  ...
  { key:'electroplating',    emoji:'⚗️', name:'Electroplating',          icon:'⚗️', label:'Electroplating / Metal Finishing',color:'#1F618D',
  ...
  { key:'printing',          emoji:'🖨️', name:'Printing',                icon:'🖨️', label:'Printing Industries',            color:'#1B4F72',
  ...
  { key:'fabrication',       emoji:'🏗️', name:'Fabrication',             icon:'🏗️', label:'Fabrication / Sheet Metal',      color:'#4D5656',
