...
const ROWS = [
  ...
  {vinv:'AI/2025/045',  vend:'Aruna Industries',         gstin:'33AABCA5631B1Z2',date:'10 Feb',txbl:'₹41,102', cgst:'₹3,699', sgst:'₹3,699', itc:'₹7,398', sb:'badge-partial',sl:' Partial'},
]
export default function GSTR2B() {
  return (
    <div>
      ...
      <div className="fi-alert info">ℹ GSTR-2B auto-populated from supplier filings. Verify and match with your purchase register before claiming ITC.</div>
